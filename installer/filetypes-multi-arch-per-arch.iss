...
Root: HKA; Subkey: "SOFTWARE\Clients\Media\{#OpenMPTarch}\Capabilities\FileAssociations"; ValueType: string; ValueName: ".667"; ValueData: {#OpenMPTFile}; Components: {#Component}
...
Root: HKA; Subkey: "SOFTWARE\Clients\Media\{#OpenMPTarch}\Capabilities\FileAssociations"; ValueType: string; ValueName: ".cba"; ValueData: {#OpenMPTFile}; Components: {#Component}
...
Root: HKA; Subkey: "SOFTWARE\Clients\Media\{#OpenMPTarch}\Capabilities\FileAssociations"; ValueType: string; ValueName: ".gmc"; ValueData: {#OpenMPTFile}; Components: {#Component}
...
Root: HKA; Subkey: "SOFTWARE\Clients\Media\{#OpenMPTarch}\Capabilities\FileAssociations"; ValueType: string; ValueName: ".ims"; ValueData: {#OpenMPTFile}; Components: {#Component}
...
Root: HKA; Subkey: "SOFTWARE\Clients\Media\{#OpenMPTarch}\Capabilities\FileAssociations"; ValueType: string; ValueName: ".puma"; ValueData: {#OpenMPTFile}; Components: {#Component}
Root: HKA; Subkey: "SOFTWARE\Clients\Media\{#OpenMPTarch}\Capabilities\FileAssociations"; ValueType: string; ValueName: ".rtm"; ValueData: {#OpenMPTFile}; Components: {#Component}
