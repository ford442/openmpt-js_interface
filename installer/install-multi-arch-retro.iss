...
MinVersion=5.1sp3
OutputDir=.\
OutputBaseFilename=OpenMPT-{#GetAppVersion}-RETRO-Setup
...
Source: ..\bin\{#BuildFolder}\x86\openmpt-pthread-win32.dll; DestDir: {app}\bin\x86; Flags: ignoreversion; Components: archx86; MinVersion: 5.1sp3
...
Source: ..\bin\{#BuildFolder}\amd64\openmpt-pthread-win32.dll; DestDir: {app}\bin\amd64; Flags: ignoreversion; Components: archamd64; MinVersion: 5.2sp2; Check: CheckDefaultArch('amd64')
...
Name: {commondesktop}\OpenMPT; Filename: {app}\bin\x86\OpenMPT.exe; Check: CheckDefaultArch('x86')
Name: {commondesktop}\OpenMPT; Filename: {app}\bin\amd64\OpenMPT.exe; Check: CheckDefaultArch('amd64')
...
Name: {group}\OpenMPT (amd64); Filename: {app}\bin\amd64\OpenMPT.exe; Components: archamd64; Check: CheckDefaultArch('amd64')
...
#include "filetypes-multi-arch-retro.iss"
...
begin
	...
	case PageID of
		wpSelectDir:
			begin
				Result := HasPreviousSingleArchInstallPath();
			end;
	end;
	case PageID of
		wpSelectComponents:
